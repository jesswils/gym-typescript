...
const Navbar = ({ selectedPage, setSelectedPage, isTopOfPage }: Props) => {
  ...
  return (
    <nav>
    <div className={`${navBackground} ${flexBetween} fixed top-0 z-30 w-full`}>
        ...
        {!isAboveMediumScreens && isMenuToggled && (
          <div className={`fixed right-0 bottom-0 z-40 h-full w-[300px] bg-tiffany-blue drop-shadow-xl`} >
            {/* close modal */}
